...
func (h *scaleExecutor) RequestScale(ctx context.Context, scalers []scalers.Scaler, scaledObject *kedav1alpha1.ScaledObject) {
	isActive := false
	...
	if currentScale.Spec.Replicas == 0 && isActive {
		...
		h.scaleFromZero(ctx, scaledObject, currentScale)
	} else if !isActive &&
		...
		h.updateLastActiveTime(ctx, scaledObject)
	} else {
...
func (h *scaleExecutor) scaleToZero(scaledObject *kedav1alpha1.ScaledObject, scale *autoscalingv1.Scale) {
...
func (h *scaleExecutor) scaleFromZero(ctx context.Context, scaledObject *kedav1alpha1.ScaledObject, scale *autoscalingv1.Scale) {
...
func (h *scaleExecutor) getScaleTargetScale(scaledObject *kedav1alpha1.ScaledObject) (*autoscalingv1.Scale, error) {
...
func (h *scaleExecutor) updateScaleOnScaleTarget(scaledObject *kedav1alpha1.ScaledObject, scale *autoscalingv1.Scale) error {
